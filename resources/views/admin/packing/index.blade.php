...
@section('page_title', 'Packing Service List')
@push('extra_styles')
	...
	<div class="main-content">
		<section class="section">
			<div class="section-header">
				<h1>@lang('Packing Service List')</h1>
				<div class="section-header-breadcrumb">
					<div class="breadcrumb-item active">
						<a href="{{ route('admin.home') }}">@lang('Dashboard')</a>
					</div>
					<div class="breadcrumb-item">@lang('Packing Service List')</div>
				</div>
			</div>
														...
														<tr>
															...
															<td data-label="@lang('Action')">
																<button data-target="#showVariantModal"
																		...
																		class="btn btn-sm btn-outline-primary showVariant">
																	<i class="fas fa-eye"></i> @lang(' Show')</button>
															</td>
				...
				<form action="{{ route('packageStore') }}" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						<div class="col-12 mt-3">
							<label for="">@lang('Package Name') <span class="text-danger">*</span></label>
							<input
								type="text"
			...
			<div class="modal-content">
				...
				<form action="{{ route('variantStore') }}" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						...
						<div class="col-12 mt-3">
							<label for="">@lang('Variant') <span class="text-danger">*</span></label>
							<input
								type="text"
						...
						<div class="col-12 mt-3">
							<div class="form-group mb-4">
								<label for="">@lang('Variant Photo') (<span class="text-danger">@lang('optional')</span>)</label>
			...
			<div class="modal-content">
				...
				<form action="" method="post" id="updateVariantForm">
					...
					<div class="modal-body">
						...
						<div class="col-12 mt-3">
							<label for="" class="variant-label">@lang('Variant') <span
			...
			<div class="modal-content">
				...
				<form action="{{ route('packingServiceStore') }}" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						...
						<div class="col-12 mt-3">
							<label for="">@lang('Cost') <span class="text-danger">*</span></label>
						...
						<div class="col-12 mt-3">
							<label for="">@lang('Weight') <span class="text-danger">*</span></label>
							<div class="input-group">
