							...
							<div class="row justify-content-md-center">
								<div class="col-lg-12">
									<div class="card mb-4 card-primary shadow">
										...
										<div class="card-body">
											<div class="switcher">
												<a href="{{ route('shipmentList', 'operator_country') }}">
													<button
														class="@if(lastUriSegment() == 'operator_country') active @endif">@lang(optional(basicControl()->operatorCountry)->name)</button>
												</a>
