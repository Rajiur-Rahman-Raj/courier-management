													...
													<div class="col-md-6">
														<div class="form-group">
															<label for="meta_keywords"
																   class="col-form-label">@lang('Meta keywords')</label>
															<input type="text" name="meta_keywords"
																   value="{{ old('meta_keywords',$basicControl->meta_keywords) }}"
																   class="inputtags form-control @error('meta_keywords') is-invalid @enderror"
																   data-role="tagsinput">
															<div class="invalid-feedback">
												...
												<div class="row">
													<div class="form-group mb-4 col-md-6">
														...
														<div id="image-preview" class="image-preview"
															 style="background-image: url({{ getFile(config('location.logo.path').'meta.png') ? : 0 }});">
