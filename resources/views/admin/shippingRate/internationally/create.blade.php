...
{{--									<form action="{{ route('shippingRateInternationally.store', 'country-wise') }}"--}}
									<form action=""
										  method="post"
										  action="" class="mt-4">
										@csrf
										<div class="row">
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="from_country_id"
														class="form-control @error('from_country_id') is-invalid @enderror select2">
											...
											<div class="col-sm-12 col-md-6 mb-3">
												...
												<select name="to_country_id"
														class="form-control @error('to_country_id') is-invalid @enderror select2">
...
{{--									<form action="{{ route('shippingRateInternationally.store', 'state-wise') }}"--}}
										...
										<div class="row">
											...
											<div class="col-sm-12 col-md-6 mb-3">
												<label for="state_id">@lang('From Country') <span
														class="text-danger">*</span></label>
												<select name="from_country_id" class="form-control @error('from_country_id') is-invalid @enderror select2 selectedFromCountry">
													<option value="" selected disabled>@lang('Select Country')</option>
													@foreach($allCountries as $country)
														<option value="{{ $country->id }}">@lang($country->name)</option>
													@endforeach
