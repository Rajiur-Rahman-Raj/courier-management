								...
								<div class="col-lg-12">
									<div class="card mb-4 card-primary shadow">
										<div
											...
											<a href="{{ route('operatorCountryRate', 'state') }}" class="btn btn-sm  btn-primary mr-2">
	...
	<script>
		...
		$(document).ready(function () {
			...
			$(document).on('click', '.editAreaRate', function () {
				...
				let selectedFromCity = $('.selectedFromCity').val();
				let selectedToCity = $('.selectedToCity').val();
				window.getSelectedFromCityArea(selectedFromCity, dataProperty.from_area_id);
				window.getSelectedToCityArea(selectedToCity, dataProperty.to_area_id);
			});
