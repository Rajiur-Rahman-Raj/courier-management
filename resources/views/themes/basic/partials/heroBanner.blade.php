...
<div class="hero_area">
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-7">
				<h1>{{ wordSplice(optional($hero->description)->title)['withoutLastTwoWord'] }} <span class="highlight">{{ array_shift($data) }}</span> {{ wordSplice(optional($hero->description)->title)['lastWord'] }} </h1>
