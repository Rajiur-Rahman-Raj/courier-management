									...
									<div class="row g-4">
										<div class="input-box col-md-12">
											...
											<div class="input-group">
												<span class="input-group-text" id="basic-addon1">{{ $basic->currency_symbol }}</span>
												<input type="text" name="balance" value="{{ Auth::user()->balance }}" class="form-control" readonly/>
											</div>
